...
Clone o repositório oficial do VST3 SDK da Steinberg.

Substitua os arquivos do diretório public.sdk/samples/vst/adelay pelos arquivos correspondentes fornecidos neste repositório.

Utilize o CMake para gerar o projeto e compile o target adelay em modo Release.

Variante Abstraída (JUCE):

Abra o arquivo de projeto .jucer fornecido utilizando o Projucer (JUCE 7.x).

Exporte o projeto para a sua IDE de preferência.

Compile o projeto selecionando o formato de saída VST3 em modo Release.

Execução do Benchmark
Caso não deseje compilar manualmente, utilize os arquivos .vst3 pré-compilados e disponíveis na raiz deste repositório.

Copie os binários para o diretório padrão de plugins VST3 do seu sistema (ex: C:\Program Files\Common Files\VST3 no Windows).

Abra o REAPER 7 e configure o sistema de áudio em Options > Preferences > Device para utilizar o ASIO4ALL com tamanho de buffer em 1024 amostras.

Carregue 50 pistas de áudio idênticas (loop em formato .ogg ou .wav).

Instancie uma variante por pista e acompanhe os dados agregados no Performance Meter (Ctrl+Alt+P).
